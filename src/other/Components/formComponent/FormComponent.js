...
export const Input = React.forwardRef((props, ref) => {
  const { onPressIn, dropdown, onFocus, id, fg, f, ta, dr = 'rtl', as, fs = 13, p, pt, pb, pl, pr, pv, ph, h = 50, w, m, mt, mb, ml, mr, mv, mh, color = '#222', bgcolor = '#fff', border = [.3], pColor = '#999', br=5 } = props;
