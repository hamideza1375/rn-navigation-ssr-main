export default function normalizationState(array, setarray = () => { }) {
  ...
  this.unshift = (data) => { let obj2 = {}; obj2[data._id] = data; obj = { ...obj2, ...obj }; this.save() }
...
// this.unshift = (data) => { const singleObj = {}; singleObj[data._id] = data; obj = { ...singleObj, obj }; this.save() }
